...
void ATetrisUSFX01GameModeBase::BeginPlay()
{
    ...
    /* FRotator Rotacion1(0.0, 0.0, 0.0);
     ...
     /*  FVector Ubicacion3(0.0, -70.0, 40.0);
       ...
       /*----------------Metodo adapter implementado para que una pieza gire lentamente sin afectar las piezas del juego-------------------------*/


    FVector Ubicacion4(0.0, 90.0, 60.0);
    FRotator Rotacion4(0.0, 0.8, 0.5);
    EstructuraConcretaActual = GetWorld()->SpawnActor<AEstructuraConcreta>(Ubicacion4, Rotacion4);
    EstructuraMultirotacionActual = GetWorld()->SpawnActor<AEstructuraMultirotacion>(AEstructuraMultirotacion::StaticClass());
    EstructuraMultirotacionActual->SetEstructura(EstructuraConcretaActual);
